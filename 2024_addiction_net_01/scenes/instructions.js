// creating a new Phaesr class - creating different segments that can be executed at different times
var SceneInstructions = new Phaser.Class({
    ...
    preload: function() {
        ...
        this.load.spritesheet('netflix', 'assets/netflix.png',
    ...
    updateText: function() {
        ...
        // start next phase
            ...
            this.instructionText.setText(`In the next part of the game, you can win points by helping an octopus catch Netflix logos. The number of points obtained will determine how much Netflix time you have during the waiting time after the game. Use the same finger you used in the previous part of the game to click the mouse and let the octopus swim towards the Netflix symbol.`);
            this.instructionText.setY(window.innerHeight*0.375) 
            ...
            this.instructionText.setText(`A text at the top of the screen will indicate whether you are close enough to the Netflix symbol to catch it. You then have to keep up with its speed as you will only win points if the octopus catches up with the Netflix symbol, or is further along when time runs out.`);
            this.instructionText.setY(window.innerHeight*0.375) 
        ...
        // next text
            ...
            this.instructionText.setText(`If you accept the challenge, you have to catch the Netflix symbol (by clicking, like you practiced) to win the points. If you reject, you do not have to do anything but wait for the same amount of time - you still get one point for waiting.`);
            this.instructionText.setY(window.innerHeight*0.375) 
